...
interface
uses graphics,DXSounds, {agfunit, TGAReader, }unitstringi;
...
type
  ...
  Tmenuuklad=array[0..10] of TMenuukladI;
...
const
  ...
  menubronie:array[0..8,0..10] of integer=
         (( 1,16,14, 8,17,26,29,31,32,38,47),
          ...
          ( 4, 0,23, 9,28,30,35,-1,-1,-1,-1),
          (39,49,50,-1,-1,-1,-1,-1,-1,-1,-1)
         );
...
{        surf:TAGFImage;}
  ...
  Tdruzyna=record
        ...
        anibron:array[0..18] of array of record  {w odpowiednich animacjach gdzie i w ktora strone ma wisiec bomba zalozona}
            x,y:integer;{licz od srodka!} {w ktorym miejscu klatki}
            kat:byte;                   {w ktorej klatce}
            end;
        ...
        maxamunicji:array[1..3] of smallint; {maxymalna ilosc amunicji poszczegolnych broni}
...
var
  ...
  bron:record
       ...
       glownytryb:byte; {0-strzelanie itd, 1-rysowanie, 2-stawianie wejsc, 3-przesuwanie wejscia}
  ...
  bronmenuuklad:array [0..max_broni] of Tmenuuklad=
      ( { 0dmuch}((typ:0; mn:0; mx:10; wartosc:5; ikona:1),(),() ,(),(),() ,(),(),(), (), ()),
        ...
        {20-----}((),(),() ,(),(),() ,(),(),(), (), ()),
        {21dynam}((typ:1; mn:15; mx:100; wartosc:30; ikona:1),(typ:1; mn:5; mx:1500; wartosc:200; ikona:2),() ,(),(),() ,(),(),(), (), ()),
  ...
  rysmenuuklad:array [0..3] of Tmenuuklad=
